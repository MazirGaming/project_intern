...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <input id="title" onkeyup="ChangeToSlug();" type="text" class="form-control @error('name') is-invalid @enderror"
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <input type="text" class="form-control @error('old_price') is-invalid @enderror" name="old_price"
            value="{{$course->old_price ?? old('old_price') }}">
        @error('old_price')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <textarea class="@error('description') is-invalid @enderror" name="description" id="" cols="60"
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <textarea class="@error('content') is-invalid @enderror" name="content" id="" cols="60"
            rows="10">{{old('content') ? old('content') : $course->content ?? ''}}</textarea>
        @error('content')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <div class="input-group">
            <input class="form-control" type="text" id="valueInput" name="add-benefits"
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <input type="text" id="benefits" class="form-control @error('benefits') is-invalid @enderror" name="benefits"
            value="{{$course->benefits ?? old('benefits')}}">
        @error('benefits')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
    </div>
